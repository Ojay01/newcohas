  ...
  @csrf
    <div class="form-row">
      ...
      <div class="form-group mb-1">
        ...
        <textarea name="notice" class="form-control" rows="8" cols="80" required>Notice</textarea>
        <small id="name_help" class="form-text text-muted">Provide More details</small>
      </div>
