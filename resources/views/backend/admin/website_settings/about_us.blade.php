...
<div class="card">
  <div class="card-body">
    ...
    <form method="POST" class="col-12 aboutUsSettings" action="#" id = "about_us_settings">
    @csrf
      <div class="row justify-content-left">
        <div class="col-12">
          <div class="form-group row mb-3">
            ...
            <div class="col-md-9">
              <textarea name="about_us" id="about_us" class="form-control" rows="8" cols="80">About Us</textarea>
            </div>
          </div>
          <div class="form-group row mb-3">
          ...
          <div class="text-center">
            <button type="submit" class="btn btn-secondary col-xl-4 col-lg-4 col-md-12 col-sm-12" onclick="updateAboutUsSettings()">Update Settings</button>
          </div>
        </div>
      </div>
    </form>
