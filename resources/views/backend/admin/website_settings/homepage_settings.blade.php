...
<div class="card">
  <div class="card-body">
    <h4 class="header-title">Homepage Image Settings</h4>
    <form method="POST" class="col-12 homepageSliderSettings" action="{{ route('updateSliders') }}" id="homepage_slider_settings" enctype="multipart/form-data">
      @csrf
      <div class="row justify-content-left">
        <div class="col-12">
          ...
          <div class="form-group row mb-3">
            <label class="col-md-3 col-form-label" for="slider_image_{{ $i }}">Slider Image {{ $i + 1 }}</label>
              ...
              <div class="wrapper-image-preview" style="margin-left: -6px;">
                ...
                <div class="js--image-preview" style="background-image: url('{{ asset('storage/app/public/slider_images/'.$sliderImages[$i]['image']) ?? ''}}'); background-color: #F5F5F5;"></div>
                  ...
                  <div class="upload-options">
                    <label for="slider_image_{{ $i }}" class="btn"> <i class="mdi mdi-camera"></i> Upload Image {{ $i + 1 }} <small>(1900 X 1260)</small></label>
