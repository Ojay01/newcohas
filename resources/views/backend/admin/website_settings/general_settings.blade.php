...
<div class="card">
  <div class="card-body">
    ...
    <form method="POST" class="col-12 generalSettingsAjaxForm" action="#" id = "general_settings">
    @csrf
      <div class="row justify-content-left">
        <div class="col-12">
          <div class="form-group row mb-3">
            ...
            <div class="col-md-9">
              <input type="text" id="website_title" name="website_title" class="form-control"  value="#" required>
            </div>
          </div>
          ...
          <div class="form-group row mb-3">
            ...
            <div class="col-md-9">
              <div class="input-group">
                ...
                <input type="text" class="form-control" name="google_link" value="#">
              </div>
            </div>
          </div>
          ...
          <div class="form-group row mb-3">
            ...
            <div class="col-md-9">
              <input type="text" id="homepage_note_title" name="homepage_note_title" class="form-control"  value="#" required>
            </div>
          </div>
          ...
          <div class="form-group row mb-3">
            ...
            <div class="col-md-9">
              <textarea name="homepage_note_description" id="homepage_note_description" class="form-control" rows="8" cols="80">Hompage Description</textarea>
            </div>
          </div>
          ...
          <div class="form-group row mb-3">
            ...
            <div class="col-md-9">
              <div class="input-group">
                ...
                <input type="text" class="form-control" name="copyright_text" value="#">
              </div>
            </div>
          </div>
